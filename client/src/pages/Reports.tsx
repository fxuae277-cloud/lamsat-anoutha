...
import { Calendar, Clock, Download, Banknote, CreditCard, Building2, TrendingUp, TrendingDown, DollarSign, ArrowLeftRight } from "lucide-react";
      ...
      {report && (
        <div className="space-y-4 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            ...
            <StatCard title="صافي اليوم" value={omr(report.net)} icon={DollarSign} color={parseFloat(report.net) >= 0 ? "text-emerald-700" : "text-red-700"} />
          </div>
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div>
        ...
        <p className="text-muted-foreground mt-1">تقارير الشفتات والتقارير اليومية مع تفصيل حسب طريقة الدفع.</p>
      </div>
